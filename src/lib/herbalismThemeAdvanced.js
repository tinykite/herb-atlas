export default [
	...
	},
	{
		...
		paint: {
			...
			'fill-color': [
				...
				'#9cd3b4',
				['in', ['get', 'kind'], ['literal', ['wood', 'nature_reserve', 'forest']]],
				'#a0d9a0',
	...
	},
	{
		...
		'source-layer': 'roads',
		minzoom: 12,
		filter: ['all', ['has', 'is_bridge'], ['==', 'kind', 'highway'], ['!has', 'is_link']],
		paint: {
			'line-color': '#e0e0e0',
			'line-gap-width': ['interpolate', ['exponential', 1.6], ['zoom'], 3, 0, 3.5, 0.5, 18, 15],
			'line-width': ['interpolate', ['exponential', 1.6], ['zoom'], 7, 0, 7.5, 1, 20, 15]
	...
	},
	{
		...
		layout: {
			...
			'text-font': ['Libre Franklin Italic'],
			'text-field': [
				'case',
				[
					'all',
				...
				[
					...
					[
						...
						[
							...
							[
								'case',
								['all', ['!', ['has', 'name:en']], ['has', 'name:en'], ['!', ['has', 'script']]],
								'',
							...
							],
							{
								'text-font': [
									...
									['literal', ['Libre Franklin Medium']]
								]
							}
						],
						['get', 'name:en']
					],
					['format', ['coalesce', ['get', 'name:en'], ['get', 'pgf:name'], ['get', 'name']], {}]
				],
				[
					'all',
					['any', ['has', 'name'], ['has', 'pgf:name']],
	...
	},
	{
		...
		source: 'protomaps',
		'source-layer': 'water',
		filter: ['in', 'kind', 'sea', 'ocean', 'lake', 'water', 'bay', 'strait', 'fjord'],
		layout: {
			'text-font': ['Libre Franklin Italic'],
			'text-field': [
				'case',
	...
	},
	{
		...
		layout: {
			'icon-image': ['match', ['get', 'kind'], 'station', 'train_station', ['get', 'kind']],
			'text-font': ['Libre Franklin Medium'],
			'text-justify': 'auto',
			'text-field': [
				'case',
		...
		paint: {
			'text-color': [
				...
				[
					'in',
					['get', 'kind'],
					['literal', ['beach', 'forest', 'marina', 'park', 'peak', 'zoo', 'garden', 'bench']]
				],
				'#20834D',
				[
					'in',
	...
	},
	{
		...
		layout: {
			'symbol-sort-key': ['get', 'min_zoom'],
			'text-field': ['format', ['coalesce', ['get', 'name:en'], ['get', 'name:en']], {}],
			'text-font': ['Libre Franklin Medium'],
			'text-size': [
				'interpolate',
				['linear'],
